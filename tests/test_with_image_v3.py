...
def test_remix_images_sends_gpt_image_2_edit_size_preset(monkeypatch, tmp_path):
...
def test_remix_images_sends_auto_image_size(
...
def test_remix_images_sends_landscape_gpt_image_2_edit_size_preset(
    monkeypatch, tmp_path
):
    captured = _capture_submit(monkeypatch)
...
def test_remix_images_keeps_custom_dimensions_for_other_fal_models(
    monkeypatch, tmp_path
):
    captured = _capture_submit(monkeypatch)
